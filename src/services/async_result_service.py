                ...
                if 'report_results' in resp_result:
                    ...
                    for i, report_result_item in enumerate(resp_result['report_results']):
                        ...
                        formatted_result.append({
                            ...
                            "distribution_type": params.get('distribution_type', req_param.get("distribution_type", "")),
                            "IT_include_type": params.get('IT_include_type', req_param.get("IT_include_type", "")),
                    ...
                    formatted_result = [{
                        ...
                        "distribution_type": req_param.get("distribution_type", ""),
                        "IT_include_type": req_param.get("IT_include_type", ""),
